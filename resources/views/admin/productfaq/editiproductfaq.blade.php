    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Product Faq</h3>
            </div>
        </div>
    </div>
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('productfaq.update', $data->id) }}">
            @csrf
            @method('PUT')
                            ...
                            <select class="form-select" id="product_id" name="product_id" required>
                              ...
                              <div class="row g-3 align-items-center">
                                <option value="{{ $product->id }}"
                                    {{ (isset($data) && $product->id == $data->product_id) ? 'selected' : '' }}>
