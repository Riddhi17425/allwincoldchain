    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Edit Service Faq</h3>
            </div>
        </div>
    </div>
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('servicefaq.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        ...
                        <div class="col-sm-12">
                            <label for="industry_id" class="form-label">Please Select The Service Name </label>
                            <select class="form-select" id="industry_id" name="industry_id" required>
                                <option value="" disabled selected>Select Service</option>
                                @foreach ($servicelist as $service)
                              <div class="row g-3 align-items-center">
                                <option value="{{ $service->id }}"
                                    {{ (isset($data) && $service->id == $data->service_id) ? 'selected' : '' }}>
