                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->bg_image) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->about_image) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->missson_image) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->vision_image) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->goal_image) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->who_image_f) }}" width="100" class="me-2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="image-container d-flex align-items-center mb-2">
                                <img src="{{ asset('public/About-us images/' . $data->who_image_s) }}" width="100" class="me-2">
                            </div>
                        </div>
