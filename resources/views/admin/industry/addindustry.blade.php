                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="industry_header" name="industry_header" required class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" name="industry_header_image" class="form-control">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" id="wall_image" name="wall_image" class="form-control">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="is_check" value="1" @if (old('is_check') == 1 ) checked @endif class="form-check-input">
                                <label class="form-check-label" for="is_check">Check for not show indutry</label>
                            </div>
                        </div>
