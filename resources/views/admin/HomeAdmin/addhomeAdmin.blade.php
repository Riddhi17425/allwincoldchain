            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    <div class="card-header py-3 p-0 d-flex justify-content-between bg-transparent border-bottom-0">
                        <h6 class="mb-0 fw-bold">Home Information</h6>
                    </div>
                            ...
                            <div id="how_works_fields">
                                <div class="row g-3 how-works-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="banner_image[]" required class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-danger how-works-row">Remove</button>
                                    </div>
                                </div>
                            </div>
                        </div>
