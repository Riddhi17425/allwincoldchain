...
<div class="container-xxl">
    @php
    $totalIndustries = DB::table('industry')->where('is_delete', '0')->count();
    $totalServices = DB::table('service')->where('is_delete','0')->count();
    $totalProduct = DB::table('product')->where('is_delete','0')->count();
    @endphp
            ...
            <div class="alert-info alert mb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill ms-3 text-truncate">
                        <div class="h6 mb-0">Total Industries</div>
                        <span class="small">{{$totalIndustries}}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="alert-info alert mb-0">
                <div class="d-flex align-items-center">
                    <div class="avatar rounded no-thumbnail bg-info text-light"><i class="fa fa-shopping-bag"
                            aria-hidden="true"></i></div>
                    <div class="flex-fill ms-3 text-truncate">
                        <div class="h6 mb-0">Total Services</div>
                        <span class="small">{{$totalServices}}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="alert-info alert mb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill ms-3 text-truncate">
                        ...
                        <span class="small">{{$totalProduct}}</span>
                    </div>
                </div>
            </div>
        </div>
