...
@section('title', 'Industry Faq Add')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Industry Faq Add</h3>
            </div>
        </div>
    </div> <!-- Row end -->

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('industryfaq.store') }}">
            @csrf
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-sm-12">
                            ...
                            <select class="form-select" id="industry_id" name="industry_id" required>
                                ...
                                <option value="{{ $industry->id }}">{{ $industry->industry_header }}</option>
                                @endforeach
                            </select>
                        </div>
