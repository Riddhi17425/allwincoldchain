...
<img src="{{asset('public/service-images/'. $data->service_header_image)}}" alt="{{$data->service_header_image}}" class="header-img1">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 m-auto">
                <div class="hero-heading-area heading1 text-center">
                    <h1>{{$data->service_header}}</h1>
                    <a href="{{ url('/')}}" class="backline">Home <i class="fa-solid fa-angle-right"></i><span>{{$data->service_header}}</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="work-header-area heading2">
                    <h5 data-aos="fade-left" data-aos-duration="800" class="aos-init aos-animate">How it work</h5>
                            ...
                            <li class="nav-item aos-init" role="presentation" data-aos="fade-left" data-aos-duration="{{800 + ($index * 200)}}">
                                <button class="nav-link @if($index == 0) active @endif" id="pills-work{{$index + 1}}-tab" data-bs-toggle="pill" data-bs-target="#pills-work{{$index + 1}}" type="button" role="tab" aria-controls="pills-work{{$index + 1}}" aria-selected="{{ $index == 0 ? 'true' : 'false' }}">
                                    <span class="workicons">
                                        <img src="{{asset('public/service-images/'.$tab['work_tab_icons'])}}" alt="{{$tab['work_tab_icons']}}" class="header-img1">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade @if($index == 0) show active @endif" id="pills-work{{$index + 1}}" role="tabpanel" aria-labelledby="pills-work{{$index + 1}}-tab" tabindex="0">
                            <div class="works-side-area">
                                <div class="images">
                                    <img src="{{asset('public/service-images/'. $tab['work_tab_images']) }}" alt="{{$tab['work_tab_images']}}">
                                </div>
                ...
                <div class="service-rightside-area heading2" style="padding: 0;">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="space32"></div>
                            <div class="img1">
                                <img src="{{asset('public/service-images/'.$data->key_image)}}"  alt="{{$data->key_image}}">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="space32"></div>
